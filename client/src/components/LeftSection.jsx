...
const LeftSection = () => {
  return (
    ...
    >
      ...
      <Element />
      <div className="relative m-10 my-15 p-5 rounded-md overflow-hidden border-2 border-white">
        <div className="absolute inset-0 bg-white/5 backdrop-blur-sm"></div>
        <div className="relative z-10">
          <img src={dq} alt="quote icon" className="w-6 mb-3" />
          <p className="mb-4 text-white text-xl">"The best way to learn to code is to code."</p>
